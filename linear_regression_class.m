function [w_out, b_out, errortr, errorv ] = linear_regression_class( x, y, valx, valy, w, b, alpha, its, lr )
...
tmp2 = valy - round(y_valid);

%calculate MSE
errortr = sum(tmp)/n_train;
errorv = sum(tmp2)/n_valid;
